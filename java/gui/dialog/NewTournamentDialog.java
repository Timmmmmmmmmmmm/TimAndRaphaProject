...
public class NewTournamentDialog {
    ...
    public static void show() {
        ...
        leftList.setCellRenderer((list, value, index, isSelected, cellHasFocus) -> new DefaultListCellRenderer().getListCellRendererComponent(list, value.lastname + ", " + value.firstname, index, isSelected, cellHasFocus));
    ...
    private static void addTournament(String name, String city, String base, String move) {
        System.out.println("START --- ADD TOURNAMENT");
        ...
        try {
            ...
            System.out.println("ERROR --- ADD TOURNAMENT");
            return;
        }
        System.out.println("SUCCESS --- ADD TOURNAMENT");
    }
